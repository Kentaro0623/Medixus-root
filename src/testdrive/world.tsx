...
function Person({
  ...
  return (
    <g transform={`translate(${x} ${y})${flip ? ' scale(-1,1)' : ''}`} opacity={dim ? 0.55 : 1}>
      <ellipse cx={0} cy={17} rx={11} ry={4} fill="rgba(20,38,74,0.14)" />
...
function Chair({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x} ${y})`}>
      <rect x={-16} y={-12} width={32} height={26} rx={7} fill="#e5eef8" stroke="#c4d8ef" strokeWidth={2} />
      <rect x={-16} y={-16} width={32} height={7} rx={3.5} fill="#c4d8ef" />
    </g>
  );
}
...
function Plant({ x, y, s = 1 }: { x: number; y: number; s?: number }) {
  return (
    <g transform={`translate(${x} ${y}) scale(${s})`}>
      <ellipse cx={0} cy={14} rx={12} ry={4} fill="rgba(20,38,74,0.10)" />
...
function Tree({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x} ${y})`}>
      <ellipse cx={0} cy={26} rx={20} ry={6} fill="rgba(20,38,74,0.10)" />
...
function Bed({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x} ${y})`}>
      ...
      <rect x={7} y={8} width={40} height={22} rx={8} fill="#e5eef8" />
...
function DeviceScreen({ x, y, w, h, on }: { x: number; y: number; w: number; h: number; on: boolean }) {
  return (
    <g>
      <rect x={x} y={y} width={w} height={h} rx={4} fill="#172038" />
      <rect x={x + 2.5} y={y + 2.5} width={w - 5} height={h - 5} rx={2.5}
        style={{ fill: on ? '#2f7fd4' : '#232f47', transition: 'fill .5s' }} />
      {on && <rect x={x + 2.5} y={y + 2.5} width={w - 5} height={h - 5} rx={2.5} fill="#dcecfb" opacity={0.35} />}
    </g>
  );
}
...
function Kiosk({ x, y, on }: { x: number; y: number; on: boolean }) {
  return (
    <g transform={`translate(${x} ${y})`}>
      <ellipse cx={0} cy={26} rx={18} ry={5} fill="rgba(20,38,74,0.12)" />
      <rect x={-5} y={0} width={10} height={24} rx={4} fill="#2b3750" />
      <g transform="rotate(-8)">
        <rect x={-19} y={-26} width={38} height={28} rx={5} fill="#172038" />
        <rect x={-15.5} y={-22.5} width={31} height={21} rx={3} style={{ fill: on ? '#2f7fd4' : '#2e3d3a', transition: 'fill .5s' }} />
        {on && <rect x={-15.5} y={-22.5} width={31} height={21} rx={3} fill="#dcecfb" opacity={0.4} />}
      </g>
    </g>
  );
}
...
function ClinicWorldBase({ flows, marker, onMarkerClick, step, fluid, children }: ClinicWorldProps) {
  ...
  return (
    ...
    >
      ...
      {/* ── clinic building ── */}
      <rect x={158} y={166} width={1190} height={790} rx={26} fill="rgba(20,38,74,0.10)" />
      <rect x={150} y={150} width={1190} height={790} rx={26} fill="#fbfcfe" stroke="#d8d3c5" strokeWidth={5} />
      <rect x={150} y={150} width={1190} height={790} rx={26} fill="url(#td-floor)" />

      {/* clinic sign */}
      <g transform="translate(745 118)">
        <circle cx={-170} cy={-4} r={16} fill="#2070cf" />
        <rect x={-176} y={-7} width={12} height={6} rx={2} fill="#fff" />
        <rect x={-173} y={-10} width={6} height={12} rx={2} fill="#fff" />
        <text x={-140} y={6} fontSize={32} fontWeight={800} fill="#3b4760" letterSpacing={3}>
          {CLINIC_NAME}
        </text>
      </g>
      ...
      {/* ── rooms ── */}
      {/* 診察室1 */}
      <rect x={192} y={192} width={330} height={350} rx={14} fill="#ffffff" stroke="#dbe3ee" strokeWidth={3} />
      <text x={214} y={228} fontSize={17} fontWeight={700} fill="#98a2b8" letterSpacing={3}>第1診察室</text>
      <text x={214} y={250} fontSize={12.5} fontWeight={600} fill="#b5bfd0" letterSpacing={1}>担当: {DOCTOR_ROOM1}医師</text>
      <Desk x={228} y={300} w={120} h={62} />
      <DeviceScreen x={268} y={308} w={44} h={26} on={monitorOn} />
      <Bed x={452} y={220} />
      <Person x={300} y={398} color="#eef3fa" hair="#4a4440" />
      <rect x={286} y={380} width={28} height={9} rx={4} fill="#8fb8ae" opacity={0.9} />
      <Plant x={492} y={498} s={0.9} />

      {/* 診察室2 */}
      <rect x={556} y={192} width={330} height={350} rx={14} fill="#ffffff" stroke="#dbe3ee" strokeWidth={3} />
      <text x={578} y={228} fontSize={17} fontWeight={700} fill="#98a2b8" letterSpacing={3}>第2診察室</text>
      <text x={578} y={250} fontSize={12.5} fontWeight={600} fill="#b5bfd0" letterSpacing={1}>担当: {DOCTOR_ROOM2}医師</text>
      <Desk x={592} y={300} w={120} h={62} />
      <DeviceScreen x={632} y={308} w={44} h={26} on />
      <Bed x={816} y={220} />
      <Person x={664} y={398} color="#eef3fa" hair="#5c5148" />
      <Person x={716} y={448} color="#c9b8d8" dim />

      {/* 処置・検査室 */}
      <rect x={920} y={192} width={236} height={350} rx={14} fill="#ffffff" stroke="#dbe3ee" strokeWidth={3} />
      <text x={942} y={228} fontSize={17} fontWeight={700} fill="#98a2b8" letterSpacing={3}>処置・検査室</text>
      <Bed x={952} y={250} />
      ...
      <rect x={1190} y={192} width={122} height={350} rx={14} fill="#f4faf8" stroke="#cfdff2" strokeWidth={3} />
      <text x={1251} y={228} fontSize={13} fontWeight={800} fill="#2070cf" letterSpacing={2} textAnchor="middle">MEDIXUS</text>
      ...
      <g transform={`translate(${SPOTS.core.x} ${SPOTS.core.y})`}>
        <circle r={44} fill="none" stroke="#2070cf" strokeWidth={2} opacity={0.25} className="td-core-pulse" />
        <circle r={30} fill="none" stroke="#2070cf" strokeWidth={2} opacity={0.4} />
        <circle r={20} fill="#123a66" />
        <circle r={20} fill="none" stroke="#4f9be6" strokeWidth={2} opacity={0.7} />
        <text y={6} fontSize={17} fontWeight={900} fill="#7ebcf2" textAnchor="middle">M</text>
      </g>
      <rect x={1210} y={430} width={82} height={86} rx={8} fill="#e7f1ee" stroke="#cfdff2" strokeWidth={2} />
      {[0, 1, 2].map((i) => (
        <g key={i}>
          <rect x={1220} y={442 + i * 24} width={62} height={14} rx={4} fill="#123a66" />
          <circle cx={1230} cy={449 + i * 24} r={2.6} fill="#4f9be6" />
          <circle cx={1240} cy={449 + i * 24} r={2.6} fill="#7ebcf2" opacity={0.6} />
        </g>
      ))}
      ...
      <g>
        <rect x={862} y={664} width={156} height={44} rx={8} fill="#172038" />
        <rect x={868} y={670} width={144} height={32} rx={5} fill={boardOn ? '#0e2b26' : '#232f47'} />
        {boardOn && (
          <g fontSize={15} fontWeight={800} fill="#7ebcf2" textAnchor="middle">
            <text x={896} y={692}>21</text>
            <text x={940} y={692} opacity={0.75}>23</text>
            <text x={984} y={692} opacity={0.5}>24</text>
          </g>
        )}
        <text x={940} y={652} fontSize={12.5} fontWeight={700} fill="#98a2b8" letterSpacing={2} textAnchor="middle">待合表示</text>
      </g>

      {/* ── reception zone ── */}
      <text x={214} y={742} fontSize={17} fontWeight={700} fill="#98a2b8" letterSpacing={3}>受付</text>
      ...
      <text x={SPOTS.kiosk.x} y={SPOTS.kiosk.y + 42} fontSize={12.5} fontWeight={700} fill="#b5bfd0" letterSpacing={1} textAnchor="middle">セルフ受付</text>
      <Plant x={230} y={880} />

      {/* 自動精算機 */}
      <g transform={`translate(${SPOTS.checkout.x} ${SPOTS.checkout.y - 18})`}>
        <rect x={-24} y={-22} width={48} height={44} rx={7} fill="#172038" />
        <rect x={-17} y={-15} width={34} height={20} rx={4} fill="#2f7fd4" opacity={0.9} />
        <rect x={-12} y={10} width={24} height={6} rx={3} fill="#3d4a47" />
      </g>
      <text x={SPOTS.checkout.x} y={SPOTS.checkout.y + 44} fontSize={12.5} fontWeight={700} fill="#b5bfd0" letterSpacing={1} textAnchor="middle">自動精算機</text>

      {/* ── waiting area ── */}
      <text x={820} y={742} fontSize={17} fontWeight={700} fill="#98a2b8" letterSpacing={3}>待合</text>
      ...
      {/* ── entrance ── */}
      <rect x={556} y={928} width={128} height={20} fill="#fbfcfe" />
      <rect x={560} y={932} width={56} height={12} rx={5} fill="#c0d8f0" opacity={0.9} />
      <rect x={624} y={932} width={56} height={12} rx={5} fill="#c0d8f0" opacity={0.9} />
      ...
      {/* ── pharmacy building ── */}
      <rect x={1428} y={716} width={320} height={240} rx={20} fill="rgba(20,38,74,0.10)" />
      <rect x={1420} y={700} width={320} height={240} rx={20} fill="#fbfcfe" stroke="#d8d3c5" strokeWidth={5} />
      ...
      <g transform="translate(1580 672)">
        ...
        <text x={-48} y={2} fontSize={23} fontWeight={800} fill="#3b4760" letterSpacing={3}>処方箋薬局</text>
      </g>
      ...
      <rect x={1536} y={928} width={88} height={20} fill="#fbfcfe" />
      <rect x={1540} y={932} width={80} height={12} rx={5} fill="#c0d8f0" opacity={0.9} />
      ...
      {marker && (
        <g
          ...
          role="button"
        >
          <circle className="ring" r={26} fill="none" stroke="#2070cf" strokeWidth={3} />
          <circle className="core-circle" r={20} fill="#2070cf" opacity={0.92} />
